...
# ==================================================================================
import json
from ad.src import generatedata
...
def test_database_connection(monkeypatch):
    # start ad
    generatedata.connectdb(thread=True)


def test_trainModel(monkeypatch):
    generatedata.train_model()


def test_predict_anomaly(monkeypatch, ad_ue):
    generatedata.load_model()
    generatedata.predict_anomaly(monkeypatch, ad_ue)
